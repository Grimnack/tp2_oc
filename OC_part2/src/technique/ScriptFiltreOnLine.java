...
public class ScriptFiltreOnLine {
	public static void main(String[] args) throws IOException{
		...
		for (int i = 0; i < lesPathnames.length-1; i++) {
			for (int j = i+1; j < lesPathnames.length; j++) {
				...
				ArrayList<ArrayList<Integer>> filterResult = filtre.filtreOnLine(lesSolutions);
				String FileName = nameHelper[i] + nameHelper[j] + "_FiltreOnLine.dat" ;
